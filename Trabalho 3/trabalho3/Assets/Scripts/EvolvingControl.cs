...
public class SimulationInfo
{
    ...
    public SimulationInfo(GameObject sim, D31NeuralControler playerRed, D31NeuralControler playerBlue, int individualIndexRed, int individualIndexBlue, float simTime, string fitnessFunctionRed, string fitnessFunctionBlue)
    {
        this.sim = sim;
        ...
        this.playerRed.fitnessFunction = fitnessFunctionRed;

        if (playerBlue != null)
        {
            this.playerBlue.simTime = simTime;
            this.playerBlue.fitnessFunction = fitnessFunctionBlue;
        }
...
public class EvolvingControl : MonoBehaviour
{
    ...
    public enum FitnessFunction { Fitness, FitnessBasic, FitnessVeryBasic, FitnessAttacker, FitnessMiddlefieldler };
    public FitnessFunction fitnessFunctionRed;
    public FitnessFunction fitnessFunctionBlue;
    ...
    private SimulationInfo createSimulation(int sim_i, Rect location, int indexIndRed, int indexIndBlue)
    {
        ...
        return new SimulationInfo(sim, redPlayerScript, bluePlayerScript, indexIndRed, indexIndBlue, simTime, fitnessFunctionRed.ToString(), fitnessFunctionBlue.ToString());
    }
